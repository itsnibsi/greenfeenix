...
export default function Home() {
  return (
    <main className='prose'>
      ...
      <p>GF offers consultancy and works for cities and municipalities to improve their influence in economical and ecological sustainability issues and by that  also improving social sustainability. Aim of GF works are mainly focused on public real estates (schools, hospitals, offices…) energy efficiency improvement, water consumption decrease, surplus food management/reduction and sustainable waste management based on circular economy and recycling. Coastal-/marine environment conservation planning and actions is also one way of GF works. GF can provide temporary cleanup help for cities and communities on green-/coastal areas. GF actors have a history of participation in marine/coastal- and other environmental conservation projects and the planning of such actions. We also have experience of municipal politics and activity.</p>
