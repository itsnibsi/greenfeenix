...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col p-4">
      ...
      <nav className="flex flex-col items-start gap-4 text-lg [&>a.active]:bg-green-500 [&>a.active]:text-white [&>a]:px-3 [&>a]:py-1 [&>a.active]:font-semibold [&>a:not(.active):hover]:bg-orange-200">
