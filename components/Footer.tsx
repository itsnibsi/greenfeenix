...
export default function Footer() {
  return (
    <div className="my-8 flex flex-col flex-wrap justify-between border-t-2 border-orange-200 py-8 text-gray-600 lg:flex-row">
      ...
      <nav className="flex flex-col items-center gap-4 pt-4 text-center transition-colors duration-200 lg:flex-row lg:pt-0 lg:text-left [&>a:hover]:text-orange-500 [&>a]:underline">
        <NavigationLinks />
      </nav>
    </div>
  );
